...
namespace WebApplication4.Controllers
{
    public class FarmWorkerTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FarmWorkerTypeID,FarmWorkerTypeDescr,FarmWorkerTypeActiveStatus")] FarmWorkerType farmWorkerType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FarmWorkerTypeID,FarmWorkerTypeDescr,FarmWorkerTypeActiveStatus")] FarmWorkerType farmWorkerType)
        {
            if (ModelState.IsValid)
            {
