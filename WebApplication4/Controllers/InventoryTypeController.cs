...
namespace WebApplication4.Controllers
{
    public class InventoryTypeController : Controller
    {
        ...
        public ActionResult Index(string search)
        {
            ...
            {
                inventories = inventories.Where(i => i.InventoryType.InvTypeDescr.Contains(search));
                ViewBag.Search = search; //store in ViewBag;
            }
            return View(db.InventoryTypes.OrderBy(c => c.InvTypeDescr).ToList());
        }
