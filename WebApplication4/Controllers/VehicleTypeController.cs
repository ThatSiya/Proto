...
namespace WebApplication4.Controllers
{
    public class VehicleTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VehTypeID,VehTypeDescr,VehTypeImg")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VehTypeID,VehTypeDescr,VehTypeImg")] VehicleType vehicleType)
        {
            if (ModelState.IsValid)
            {
