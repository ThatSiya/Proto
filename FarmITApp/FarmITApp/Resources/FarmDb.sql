...
CREATE TABLE [dbo].[Field] (
	...
	[FieldHectares] float not null,
    [Field StatusID] int not null foreign key references [FieldStatus]([FieldStatID]),
	[LandID] int not null foreign key references [Land](LandID)
);
GO
...
CREATE TABLE [dbo].[OrderLine](
	...
	OrderLineTotalAmount float not null,
...
CREATE TABLE [dbo].[Plantation] (
	...
	[DatePlanted] date,
	[RefugeSeedAmntUsed] float,
	[RefugeUnit] int not null foreign key references [Unit](UnitID),
	[RefugeAreaHectares] float,
	[ExpectedYieldQnty] float not null,
...
CREATE TABLE [dbo].[Silo] (
	...
	[SiloCapacity] float not null,
	[UnitID] int not null foreign key references [Unit](UnitID),
	[SiloRentalFeePA] float,
...
CREATE TABLE [dbo].[SiloHarvest] (
	...
	[SiloHarvestTonnesStored] float not null,
...
CREATE TABLE [dbo].[SiloHarvestSale] (
	...
	SiloHarvestSaleTotalAmnt float not null,
	SiloHarvestSaleTotalQty float not null
);
GO